...
class SnowBallFightGame(bs.TeamGameActivity):
    ...
    def getSettings(cls,sessionType):
        settings = [("Kills to Win Per Player",{'minValue':1,'default':5,'increment':1}),
                    ...
                    ("雪球速度",{'choices':[('Slowest',500),('Slow',400),('Normal',300),('Fast',200),('Lag City',100)],'default':300}),
                    ("雪球融化",{'default':True}),
                    ("雪球破碎",{'default':True}),
    ...
    def __init__(self,settings):
        ...
        self.snoFact.defaultBallTimeout = self.settings['雪球速度']
        self.snoFact._ballsMelt = self.settings['雪球融化']
        self.snoFact._ballsBust = self.settings['雪球破碎']
        self.snoFact._powerExpire = False
    def getInstanceDescription(self):
        return ('Crush ${ARG1} of your enemies.',self._scoreToWin)

    def getInstanceScoreBoardDescription(self):
        return ('杀死 ${ARG1} 个敌人',self._scoreToWin)
